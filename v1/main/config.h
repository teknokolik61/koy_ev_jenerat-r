...
// SÜRÜM
// =====================
#define PROJECT_VERSION "v10.005"
...
// =====================
// ADC (ADC1 ONLY) - ESP32-WROOM-32D
// =====================
inline constexpr uint8_t PIN_ADC_MAINS     = 34; // ADC1
inline constexpr uint8_t PIN_ADC_GEN       = 35; // ADC1
inline constexpr uint8_t PIN_ADC_GEN_BATT  = 32; // ADC1
inline constexpr uint8_t PIN_ADC_CAM_BATT  = 33; // ADC1
...
// Çakışmasız öneri (strap olmayan, stabil):
inline constexpr uint8_t PIN_RELAY_FUEL  = 25;
inline constexpr uint8_t PIN_RELAY_START = 26;
...
// =====================
// VSPI SCK=18, MISO=19, MOSI=23 (donanım)
inline constexpr int8_t TFT_CS  = 17;
inline constexpr int8_t TFT_DC  = 16;
inline constexpr int8_t TFT_RST = -1; // RST yoksa -1

// 0..3
inline constexpr uint8_t TFT_ROTATION = 1;

// =====================
// UI Buttons (INPUT_PULLUP) - active LOW
// =====================
inline constexpr uint8_t PIN_BTN_UP    = 13;
inline constexpr uint8_t PIN_BTN_DOWN  = 14;
inline constexpr uint8_t PIN_BTN_LEFT  = 21;
inline constexpr uint8_t PIN_BTN_RIGHT = 22;
inline constexpr uint8_t PIN_BTN_OK    = 4;   // eğer boot sorunu olursa 4 yerine başka pine alırız
inline constexpr uint8_t PIN_BTN_BACK  = 2;   // eğer boot sorunu olursa 2 yerine başka pine alırız

inline constexpr uint16_t UI_BTN_DEBOUNCE_MS  = 25;
inline constexpr uint16_t UI_REPEAT_MS        = 220;
inline constexpr uint16_t UI_REPEAT_FAST_MS   = 90;
inline constexpr uint16_t UI_REPEAT_ACCEL_MS  = 900;
...
inline constexpr uint16_t AC_MEAN_MIN_COUNTS = 200;
inline constexpr uint16_t AC_MEAN_MAX_COUNTS = 3895;
...
// =====================
// FAULT retry (şimdilik minimal kullanılıyor)
// =====================
